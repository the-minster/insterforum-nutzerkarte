...
infoBox.onAdd = function (map) {
    ...
    div.innerHTML = `
        ...
        <div id="info-content">
            ...
            <p><b>Vergib bei der Anmeldung ein Validierungswort und sende dieses anschließend in einer persönlichen Nachricht (Konversation im Forum starten) an @minster, damit dein Eintrag freigeschaltet werden kann.</b></p>
